...
const SubmittedFeedbackCard = ({ feedbackText, recipientName, onDelete=()=>{console.log("onDelete")} }) => {
  ...
  return (
    <div className="w-full bg-white shadow-lg border-l-4 border-yellow-400 p-4 rounded-none mb-4 relative">
      ...
      <div className="flex justify-between items-center mt-4">
        <div>
          <p className="text-sm text-gray-500">Anonymously Sent to</p>
          <strong className="text-sm text-gray-700">{recipientName}</strong>
        </div>
